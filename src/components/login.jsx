    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <nav className="flex items-center justify-between px-8 py-4">
        ...
        <div className="flex items-center space-x-4">
          <button className="text-white hover:text-green-400 transition-colors">Register</button>
          <button className="bg-green-500 hover:bg-green-600 px-6 py-2 rounded-full font-medium transition-colors">
            Login
          </button>
        </div>
      </nav>
          ...
          <div className="space-y-4">
            ...
            <div className="text-center mt-6">
              <p className="text-gray-400">
                New to Streamr? 
                <button className="text-green-500 hover:text-green-400 ml-1 transition-colors">
                  Sign up now.
                </button>
              </p>
            </div>
